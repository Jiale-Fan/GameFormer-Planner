...
def train_epoch(data_loader, model, optimizer):
    ...
    with tqdm(data_loader, desc="Training", unit="batch") as data_epoch:
        for batch_pair in data_epoch:
            ...
            _, results = level_k_loss(level_k_outputs, ego_future, neighbors_future, neighbors_future_valid)
...
def model_training():
    ...
    # set up data loaders
    train_set = DrivingDataAndScenario(args.train_set, args.num_neighbors)
    valid_set = DrivingDataAndScenario(args.valid_set, args.num_neighbors)

    train_loader = DataLoader(train_set, batch_size=batch_size, shuffle=True, num_workers=os.cpu_count(), collate_fn=driving_data_and_scenario_collate)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_set', type=str, help='path to train data', default='/data1/nuplan/jiale/exp/GameFormer/processed_data_train_150k')
    parser.add_argument('--valid_set', type=str, help='path to validation data', default='/data1/nuplan/jiale/exp/GameFormer/validation_data')
